...
LABEL Description="Software for working with Nanopore Sequencing files."
...
RUN wget https://github.com/azroger/HTProcess-Pipeline/archive/0.0.5.tar.gz && tar xvzf 0.0.5.tar.gz && chmod a+x HTProcess-Pipeline-0.0.5/* && cp -r HTProcess-Pipeline-0.0.5/* /usr/bin
