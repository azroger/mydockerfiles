...
RUN wget https://github.com/azroger/iPlant-basic-scripts/archive/v0.0.2.tar.gz && tar xvzf v0.0.2.tar.gz && chmod a+x iPlant-basic-scripts-0.0.2/* && cp iPlant-basic-scripts-0.0.2/* ./
